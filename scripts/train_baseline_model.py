#!/usr/bin/env python3
"""
Script to train and evaluate the Baseline model.
Usage: python scripts/train_baseline_model.py --domain DOMAIN --dataset DATASET
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train and evaluate the Baseline model")
    ...
    parser.add_argument("--strategy", choices=["popularity", "user_mean"], default="popularity",
    ...
    try:
        ...
        model.set_hyperparameters(
            recommendation_strategy=args.strategy,
            remove_seen=args.remove_seen
        )
        
        # Train the model
        logging.info(f"Training Baseline model with strategy={args.strategy}, remove_seen={args.remove_seen}")
